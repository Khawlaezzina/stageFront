...
@Component({
  selector: 'app-update-citechnicien',
  templateUrl: './update-citechnicien.component.html',
  styleUrls: ['./update-citechnicien.component.scss']
})
export class UpdateCITechnicienComponent implements OnInit {
