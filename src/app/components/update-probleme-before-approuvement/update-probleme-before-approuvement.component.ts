...
@Component({
  selector: 'app-update-probleme-before-approuvement',
  templateUrl: './update-probleme-before-approuvement.component.html',
  styleUrls: ['./update-probleme-before-approuvement.component.scss']
})
export class UpdateProblemeBeforeApprouvementComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.route.paramMap.subscribe(
     ...
     this.httpClient
     .get<any[]>("http://127.0.0.1:8443/probleme/"+this._id) 
     .subscribe(
       response=>{
  ...
  onUpdateIncident()
  {
    ...
    this.httpClient
    .put("http://127.0.0.1:8443/probleme/"+this._id,this._incidentToUpdate)
    .subscribe(
      Response=>{
