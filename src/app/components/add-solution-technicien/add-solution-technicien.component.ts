...
@Component({
  selector: 'app-add-solution-technicien',
  templateUrl: './add-solution-technicien.component.html',
  styleUrls: ['./add-solution-technicien.component.scss']
})
export class AddSolutionTechnicienComponent implements OnInit {
  incident:any;
  incidentUpdated:any;
