...
@Component({
  selector: 'app-update-solution-technicien',
  templateUrl: './update-solution-technicien.component.html',
  styleUrls: ['./update-solution-technicien.component.scss']
})
export class UpdateSolutionTechnicienComponent implements OnInit {
  incident:any;
  incidentUpdated:any;
  ...
  onUpdateIncident()
  {
    ...
    .subscribe(
      Response=>{
        ...
        this.router.navigate(['gererIncidentTechnicien']);
      }
    );
  }
