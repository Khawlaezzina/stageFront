...
export class UpdateUserComponent implements OnInit {
  ...
  _password!:string;
  _email!:string;
  constructor( private router: Router, private route: ActivatedRoute,private httpClient: HttpClient,private formBuilder:FormBuilder,private service:UserService) { }
  ...
  ngOnInit(): void {
    ...
    this.httpClient
    .get<any[]>("http://127.0.0.1:8443//UtilisateurSimple/"+this._id) 
    .subscribe(
        Response=>{
