...
@Component({
  selector: 'app-update-solution-for-problem-admin',
  templateUrl: './update-solution-for-problem-admin.component.html',
  styleUrls: ['./update-solution-for-problem-admin.component.scss']
})
export class UpdateSolutionForProblemAdminComponent implements OnInit {
  incident:any;
  incidentUpdated:any;
  incidents:any[]=[];
