...
@Component({
  selector: 'app-add-solution-problem-admin',
  templateUrl: './add-solution-problem-admin.component.html',
  styleUrls: ['./add-solution-problem-admin.component.scss']
})
export class AddSolutionProblemAdminComponent implements OnInit {
  incident:any;
  incidentUpdated:any;
