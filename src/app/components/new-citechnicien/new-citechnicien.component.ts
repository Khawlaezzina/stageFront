...
@Component({
  selector: 'app-new-citechnicien',
  templateUrl: './new-citechnicien.component.html',
  styleUrls: ['./new-citechnicien.component.scss']
})
export class NewCITechnicienComponent implements OnInit {
  newCIForm!:FormGroup;
  CI!:any;
